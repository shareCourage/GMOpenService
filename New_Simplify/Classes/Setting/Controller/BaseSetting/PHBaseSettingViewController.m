...
- (void)tableView:(UITableView *)tableView didSelectRowAtIndexPath:(NSIndexPath *)indexPath
{
    ...
    else if ([setItem isKindOfClass:[PHSettingSwitchItem class]])
    {
        PHSettingSwitchItem *switchItem = (PHSettingSwitchItem *)setItem;
        if (PH_BoolForKey(switchItem.title)) {
            [self pushVCWithClass:switchItem.destVcClass settintItem:switchItem];
        }
    }
}
