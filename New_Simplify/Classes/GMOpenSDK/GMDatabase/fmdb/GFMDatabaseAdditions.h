...
/** Category of additions for `<GFMDatabase>` class.
...
@interface GFMDatabase (GFMDatabaseAdditions)
...
/** Return `int` value for query
 ...
 @note To use this method from Swift, you must include `GFMDatabaseAdditionsVariadic.swift` in your project.
 */
...
/** The schema of the database.
 ...
 @return `GFMResultSet` of schema; `nil` on error.
